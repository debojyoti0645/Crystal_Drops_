...
class CustAppDrawer extends StatefulWidget {
  const CustAppDrawer({super.key});

  @override
  State<CustAppDrawer> createState() => _CustAppDrawerState();
}

class _CustAppDrawerState extends State<CustAppDrawer> {
            ...
            child: Container(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  // Manage Connection
                  ListTile(
                    leading: Icon(Icons.settings, color: Color(0xFF007BFF)),
                    title: Text(
                      "Manage Connection",
                      style: TextStyle(
                        fontWeight: FontWeight.w500,
                    ...
                    onTap: () {
                      // Navigate to Manage Connection Page
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.pushNamed(context, '/cust_payment');
                    },
                  ),
